...
<%--            Address addr = emp.getAddress(); // ✅ Declare address only once inside the loop--%>
<%--    %>--%>
<%--    <tr>--%>
<%--        <td><%= emp.getId() %></td>--%>
<%--        <td><%= emp.getName() %></td>--%>
...
<%--        <%--%>
<%--            if (addr != null) { // ✅ Proper null check--%>
<%--        %>--%>
...
<%--        </td>--%>
<%--&lt;%&ndash;        <td>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <form action="updateEmployee" method="post">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <input type="hidden" name="id" value="<%= emp.getId() %>">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <button type="submit">Update</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </form>&ndash;%&gt;--%>
